...
const description = createNode('div', 'description', `<p>Клавиатура создана в операционной системе Windows.</p>
                                ...
                                <p>Для использования Shift, зажмите его левой клавишей мыши и, удерживая, перетащите курсор на нужную кнопку. Отпустите зажатие - выбранный символ будет напечатан в поле вывода.</p>`);
